...
<head>
    ...
    <body>
      ...
      <li class="nav-item">
       ...
       <button type="button" class="btntop btn btn-success" data-bs-toggle="modal" data-bs-target="#Login">
            Iniciar sesion
       </button>
       <button type="button" class="btntop btn btn-info" data-bs-toggle="modal" data-bs-target="#Registro">
            Registrarse
       </button>
           <form class="d-flex">
